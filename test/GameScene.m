...
- (void)mySetGameCharacter{
    ...
    if (myCurrentGameTheme == 0) {
        ...
        CGPathAddLineToPoint(path, NULL, 8 - offsetX, 23 - offsetY);
        CGPathAddLineToPoint(path, NULL, 11 - offsetX, 25 - offsetY);
        CGPathAddLineToPoint(path, NULL, 14 - offsetX, 27 - offsetY);
        CGPathAddLineToPoint(path, NULL, 18 - offsetX, 27 - offsetY);
        CGPathAddLineToPoint(path, NULL, 23 - offsetX, 28 - offsetY);
        CGPathAddLineToPoint(path, NULL, 26 - offsetX, 28 - offsetY);
        CGPathAddLineToPoint(path, NULL, 30 - offsetX, 27 - offsetY);
        CGPathAddLineToPoint(path, NULL, 33 - offsetX, 25 - offsetY);
        CGPathAddLineToPoint(path, NULL, 36 - offsetX, 20 - offsetY);
        CGPathAddLineToPoint(path, NULL, 36 - offsetX, 17 - offsetY);
        CGPathAddLineToPoint(path, NULL, 36 - offsetX, 15 - offsetY);
        CGPathAddLineToPoint(path, NULL, 37 - offsetX, 14 - offsetY);
        CGPathAddLineToPoint(path, NULL, 39 - offsetX, 13 - offsetY);
        CGPathAddLineToPoint(path, NULL, 41 - offsetX, 12 - offsetY);
        CGPathAddLineToPoint(path, NULL, 41 - offsetX, 9 - offsetY);
        CGPathAddLineToPoint(path, NULL, 40 - offsetX, 8 - offsetY);
        CGPathAddLineToPoint(path, NULL, 39 - offsetX, 6 - offsetY);
        CGPathAddLineToPoint(path, NULL, 39 - offsetX, 4 - offsetY);
        CGPathAddLineToPoint(path, NULL, 37 - offsetX, 2 - offsetY);
        CGPathAddLineToPoint(path, NULL, 32 - offsetX, 2 - offsetY);
        CGPathAddLineToPoint(path, NULL, 28 - offsetX, 2 - offsetY);
        CGPathAddLineToPoint(path, NULL, 25 - offsetX, 1 - offsetY);
        CGPathAddLineToPoint(path, NULL, 23 - offsetX, 0 - offsetY);
